...
//
////需要登录
//static NSString *const kHPNotificationNeedLogin = @"kHPNotificationNeedLogin";
//
////登录成功
//static NSString *const kHPNotificationDidLoginSuccess = @"kHPNotificationDidLoginSuccess";
//
////退出
