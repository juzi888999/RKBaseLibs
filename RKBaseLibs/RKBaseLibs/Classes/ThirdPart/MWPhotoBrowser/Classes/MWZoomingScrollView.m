...
- (id)initWithPhotoBrowser:(MWPhotoBrowser *)browser {
    if ((self = [super init])) {
        ...
        @weakify(self);
        [_photoImageView setLongPressAction:^(UILongPressGestureRecognizer *gestureRecongnizer) {
            @strongify(self);
            if (self) {
                
                UIImageView * imageView = (UIImageView *)gestureRecongnizer.view;
                if (imageView.image) {
                    
                    UIAlertController * alertController = [UIAlertController alertControllerWithTitle:@"是否保存图片到相册" message:nil preferredStyle:UIAlertControllerStyleAlert];
                    ...
                    if ([self getViewController]) {
                        [[self getViewController] presentViewController:alertController animated:YES completion:^{
