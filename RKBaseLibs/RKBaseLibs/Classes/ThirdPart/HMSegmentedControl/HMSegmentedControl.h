...
typedef UIView* (^HMCustomView)(id item, NSInteger index);
typedef void (^HMSelectedStyleBlcok)(NSArray *views, NSInteger selectedIndex);
...
@property (nonatomic, readonly) NSArray *customViews;

@property (nonatomic, strong) CALayer *selectionIndicatorBoxLayer;
@property (nonatomic, assign) CGFloat selectionIndicatorBoxLayerHeight;
@property (nonatomic, assign) UIEdgeInsets selectionIndicatorBoxLayerInsets;
...
@property (nonatomic, copy) IndexChangeBlock tapAtIndexBlock;
@property (nonatomic, copy) HMSelectedStyleBlcok selectedStyleBlock;
@property (nonatomic, copy) BOOL(^shouldSelectedSegmentAtIndexBlock)(NSInteger index);
...
@property (nonatomic) CGFloat minSegmentWidth;

/*
 Default is NO. 是否固定indicator的宽度 , selectionStyle = HMSegmentedControlSelectionStyleArrow 不生效
 并且 segmentWidthStyle = HMSegmentedControlSegmentWidthStyleDynamic 才生效
 */
@property (assign,nonatomic) BOOL fixIndicatorWidth;
/*
 Default is 15. 只有 fixIndicatorWidth = YES 的时候生效, 固定的indicator宽度值
 */
@property (assign,nonatomic) CGFloat indicatorWidthForFixed;

@property (assign,nonatomic) BOOL alignmentCenter;//default is NO
